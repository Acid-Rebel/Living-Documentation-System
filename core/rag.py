...
from core.prompts import RAG_SYSTEM_PROMPT as system_prompt, RAG_TEMPLATE
...
class RAG(adal.Component):
    ...
    def __init__(self, provider="google", model=None, use_s3: bool = False):  # noqa: F841 - use_s3 is kept for compatibility
        ...
        from core.config import get_embedder_config, get_embedder_type
        ...
        if self.is_ollama_embedder:
            from core.ollama_patch import check_ollama_model_exists
