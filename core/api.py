...
from core.config import configs, WIKI_AUTH_MODE, WIKI_AUTH_CODE
...
from core.simple_chat import chat_completions_stream
from core.websocket_wiki import handle_websocket_chat
...
# Add Living Docs System intelligence router
from core.lds_router import router as lds_router
app.include_router(lds_router)
