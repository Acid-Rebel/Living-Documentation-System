...
const DEMO_FLOW_CHART = `graph TD
  A[Code Repository] --> B[Living Documentation System]
...
const DEMO_SEQUENCE_CHART = `sequenceDiagram
  participant User
  participant Living Documentation System
  participant GitHub

  User->>Living Documentation System: Enter repository URL
  Living Documentation System->>GitHub: Request repository data
  GitHub-->>Living Documentation System: Return repository data
  Living Documentation System->>Living Documentation System: Process and analyze code
  Living Documentation System-->>User: Display documentation with diagrams

  %% Add a note to make text more visible
  Note over User,GitHub: Living Documentation System supports sequence diagrams for visualizing interactions`;
...
export default function Home() {
  ...
  const [repositoryInput, setRepositoryInput] = useState('https://github.com/Acid-Rebel/Living-Documentation-System');
  ...
  const handleFormSubmit = (e: React.FormEvent) => {
    ...
    if (!parsedRepo) {
      setError('Invalid repository format. Use "owner/repo", GitHub/GitLab URL, or a local folder path like "/path/to/folder" or "C:\\path\\to\\folder".');
      return;
    }
        ...
        <div
          ...
          <div className="flex items-center">
            <div className="mr-3">
              <Image
                src="/logo.png"
                alt="Living Documentation System logo"
                width={48}
                height={48}
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <div className="relative flex-1">
                <input
                  ...
                  placeholder={t('form.repoPlaceholder') || "owner/repo, GitHub/GitLab URL, or local folder path"}
        ...
        <div
              ...
              <div className="flex flex-col items-center w-full max-w-2xl mb-8 mx-auto">
                <div className="flex flex-col sm:flex-row items-center mb-6 gap-4">
                  <div className="relative">
                    ...
                    <Image src="/logo.png" alt="Living Documentation System logo" width={56} height={56} className="relative z-10 rounded-xl" />
                  </div>
          ...
          <div
            ...
            <div className="grid grid-cols-1 gap-3 text-xs text-[var(--muted)]">
              ...
              >https://github.com/Acid-Rebel/Living-Documentation-System
              </div>
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              ...
              <div
                className="bg-[var(--background)]/70 p-3 rounded border border-[var(--border-color)] font-mono overflow-x-hidden whitespace-nowrap"
              >Acid-Rebel/Living-Documentation-System
              </div>
          </div>
          </div>
          ...
          <div className="w-full max-w-2xl mb-10">
            <h3 className="text-base font-semibold text-[var(--foreground)] font-serif mb-4 text-center">Platform Features</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="bg-[var(--card-bg)] p-4 rounded-lg border border-[var(--border-color)] shadow-custom">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--foreground)]">AI-Enhanced Diagrams</h4>
                </div>
                <p className="text-xs text-[var(--muted)]">Auto-generated class, dependency, and sequence diagrams using AI analysis of your codebase.</p>
              </div>
              ...
              <div className="bg-[var(--card-bg)] p-4 rounded-lg border border-[var(--border-color)] shadow-custom">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--foreground)]">NLP Code Summarizer</h4>
                </div>
                <p className="text-xs text-[var(--muted)]">Natural language summaries of your repository modules, complexity analysis, and key findings.</p>
              </div>
              ...
              <div className="bg-[var(--card-bg)] p-4 rounded-lg border border-[var(--border-color)] shadow-custom">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--foreground)]">Documentation PRs</h4>
                </div>
                <p className="text-xs text-[var(--muted)]">Create, review, approve, and merge documentation pull requests directly from the UI.</p>
              </div>
              ...
              <div className="bg-[var(--card-bg)] p-4 rounded-lg border border-[var(--border-color)] shadow-custom">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h4 className="text-sm font-semibold text-[var(--foreground)]">Drift Detection & More</h4>
                </div>
                <p className="text-xs text-[var(--muted)]">Semantic insights, dependency intelligence, documentation drift analysis, and AI-powered Q&A.</p>
              </div>
            </div>
          </div>
        ...
        <div
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center space-x-5">
              <a href="https://github.com/Acid-Rebel/Living-Documentation-System" target="_blank" rel="noopener noreferrer"
